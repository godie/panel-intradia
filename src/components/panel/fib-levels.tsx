  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-center justify-between">
        ...
        >
          {isUp ? t("card.fibUptrend") : t("card.fibDowntrend")}
        </span>
      </div>
      ...
      <div className="flex items-center justify-between rounded-md border border-white/5 bg-black/15 px-2.5 py-1 text-[10px]">
        <div className="flex items-center gap-1.5">
          <span className="text-muted-foreground/60">{t("overview.swings")}</span>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-muted-foreground/60">{t("overview.swingl")}</span>
        </div>
      </div>
